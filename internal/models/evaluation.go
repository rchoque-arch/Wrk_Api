...
// Rubric represents the Rubric structure.
type Rubric struct {
...
// TableName overrides the table name used by GORM for c.
func (Rubric) TableName() string {
	return "rubrics"
}

// Criteria represents the Criteria structure.
...
// TableName overrides the table name used by GORM for a.
func (Criteria) TableName() string {
	return "criteria"
}

// Evaluation represents the Evaluation structure.
...
// TableName overrides the table name used by GORM for n.
func (Evaluation) TableName() string {
	return "evaluations"
}

// EvaluationCriteria represents the EvaluationCriteria structure.
